...
//        git clone https://github.com/ozkl/doomgeneric cells/demos/doom/src/c/doomgeneric
...
fn link_picolibc() {
    ...
    // Redirect picolibc malloc's _sbrk calls to __wrap__sbrk defined in main.rs.
    // Without this, sysio.rs's _sbrk (returns NULL) causes Z_Init to get NULL
    // from malloc and call I_Error("couldn't allocate zone heap") immediately.
