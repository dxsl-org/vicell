#!/usr/bin/env python3
"""Append the ViOS cell bootstrap table to an existing disk image.

The bootstrap table is appended at CELL_TABLE_BASE_LBA (82000 sectors = ~42 MB),
...
CELL_TABLE_MAGIC  = 0x5649_4F53_5F43_454C  # "VIOS_CEL"
CELL_PATH_LEN     = 64
MAX_CELL_ENTRIES  = 32
